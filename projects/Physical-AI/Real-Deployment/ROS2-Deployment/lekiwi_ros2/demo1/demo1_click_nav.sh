...
# ============ DEMO 1: click a goal in RViz -> LeKiwi drives there ============
# Auto-cleans everything on start AND exit (fresh from 0 every run).
# Put the robot at the recording START position before running. Ctrl-C to stop.
...
echo ">>> pre-clean (start from 0)"; $CLEAN; sleep 1
...
echo ">>> [5/5] RViz"; rviz2 -d /opt/ros/jazzy/share/nav2_bringup/rviz/nav2_default_view.rviz >$LOG/rviz.log 2>&1 &

echo
echo "=================================================================="
echo "  DEMO 1 READY.  RViz: 'Nav2 Goal' -> click a WHITE area -> release."
echo "  Ctrl-C here to stop + auto-clean everything."
echo "=================================================================="
wait
